"""Custom operator for transform phase."""
...
class TransformationOperator(BaseOperator):
    """Executes the transform pipeline module."""
    ...
    def execute(self, context):
        self.log.info(f"Starting TransformationOperator execution")
        try:
            if "transform" == "data_generator":
            ...
            elif "transform" == "warehouse":
                import warehouse.warehouse_manager

                warehouse.warehouse_manager.main()
            elif "transform" == "analytics":
                import analytics.analytics_manager

                analytics.analytics_manager.main()

            self.log.info(f"Successfully completed TransformationOperator")
        except Exception as e:
            self.log.error(f"TransformationOperator failed: {e}")
            raise
