...
PROCESSED_SCHEMAS: dict[str, list[str]] = {
    "customers": [
        ...
        "gender", "date_of_birth", "city", "state", "country", "zipcode",
        "signup_date", "is_active", "customer_segment", "customer_age",
        "customer_tenure_days",
    ],
    "products": [
        "product_id", "product_name", "category", "brand", "supplier",
        "cost_price", "selling_price", "profit_margin", "weight", "rating",
        "launch_date", "is_active", "sku", "low_margin_flag", "profit",
    ],
    "inventory": [
        "inventory_id", "product_id", "warehouse", "current_stock",
        "reorder_level", "last_updated", "warehouse_city", "inventory_status",
    ],
    "orders": [
        "order_id", "customer_id", "order_date", "product_id", "quantity",
        "unit_price", "discount", "tax", "shipping_cost", "payment_id",
        "shipping_id", "order_status", "total_amount", "order_year",
        "order_month", "order_quarter", "discount_percentage", "order_value",
        "items_count",
    ],
    "payments": [
    ...
    "shipping": [
        ...
        "dispatch_date", "delivery_date", "shipping_status", "delivery_city",
    ],
    "reviews": [
        "review_id", "customer_id", "product_id", "rating", "review_title",
        "review_text", "review_date", "verified_purchase", "review_sentiment",
    ],
...
def apply_schema(dataset: str, rows: list[dict[str, Any]]) -> tuple[list[dict[str, Any]], list[str]]:
