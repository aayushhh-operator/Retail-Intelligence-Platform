...
class LoadHistoryRecorder:
    ...
    def record_pipeline_run(self, run_id: str, status: str, start_time: datetime, end_time: datetime) -> None:
    ...
    def record_load(self, run_id: str, dataset: str, rows_read: int, rows_loaded: int, rows_failed: int, strategy: str, status: str) -> None:
