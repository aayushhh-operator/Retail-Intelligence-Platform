...
def main() -> None:
    ...
    try:
        ...
        history_recorder.record_pipeline_run(pipeline_run_id, "RUNNING", start_time, datetime.now())
        
        datasets = ["customers", "products", "inventory", "orders", "payments", "shipping", "reviews", "website_events"]
        ...
        for dataset in datasets:
            ...
            try:
                ...
                logger.error(f"Error loading {dataset}. Pipeline will continue. Error: {e}")
        ...
        # 4. Record Success
        history_recorder.record_pipeline_run(pipeline_run_id, "SUCCESS", start_time, datetime.now())
        ...
        history_recorder.record_pipeline_run(pipeline_run_id, "FAILED", start_time, datetime.now())
    finally:
        connection.dispose()
